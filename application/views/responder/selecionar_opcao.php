                    ...
                    <div class="card-header" style="background-color: #228B22; border-color:#228B22">Respostas dos Usuários</div>
                        ...
                        <form action="<?php echo base_url('responder/usuarios')?>" method="POST">
                          ...
                          <div class="form-group row">
                              <label for="pr_pergunta" class="col-md-4 col-form-label text-md-right" id="color2">Opção/Resposta Disertativa:</label>
                                <div class="col-md-6">
                                  <select name="id_opcao" class="form-control">
                                    <?php foreach ($tb_opcao as $linha):?>
                                    <option value="<?=$linha->id_opcao?>"><?=$linha->ds_opcao?></option>
                                    <?php endforeach ?>
                                  </select>
                                </div>
                          </div>
