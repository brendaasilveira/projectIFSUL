            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color: #228B22; border-color:#228B22">Respostas dos Usuários</div>
                    	<div class="card-body">
                        <form action="<?php echo base_url('responder/selecionar_opcao')?>" method="POST">
                              ...
                              <label for="pr_pergunta" class="col-md-4 col-form-label text-md-right" id="color2">Pergunta:</label>
                                <div class="col-md-6">
                                  <select name="id_pergunta" class="form-control">
                                    <?php foreach ($tb_pergunta as $linha):?>
                                    <option value="<?=$linha->id_pergunta?>"><?=$linha->pr_pergunta?></option>
                                    <?php endforeach ?>
                                  </select>
                                </div>
                          </div>
