            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color: #228B22; border-color:#228B22"> Listar Questionários</div>
                    	<div class="card-body">
                        <form action="<?php echo base_url('questionario/index')?>" method="POST">
													...
													<table class="table table-hover" id="tabela">
														  <thead>
														  		<a href="<?php echo base_url("questionario/cadastrar")?>" style=" margin-top: 2px; margin-left: 290px; margin-right: 5px;" class="btn btn-success btn-sm">Cadastrar Novo Questionário</a>
															    <tr>
														  ...
														  <tbody>
														  		<?php foreach ($questionario as $linha): ?>
																    <tr>
																	     ...
																	     <td>
																	     	<a href="<?php echo base_url("questionario/editar/$linha->id_questionario")?>" class="btn btn-success btn-sm">
																	     		Editar
																	     	</a>
																	     </td>
																    </tr>
